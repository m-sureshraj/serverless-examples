...
export const handler = async event => {
  ...
  try {
    ...
    console.info(
      'Invalidated all identity, access and refresh tokens that Amazon Cognito has issued to a user'
    );
  } catch (error) {
    console.error(
      'An error occurred while trying to invalidate the identity, access and refresh tokens',
      error
    );
  }
